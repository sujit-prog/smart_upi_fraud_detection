...
const RiskSummaryCard = ({ transactions }) => {
  ...
  const icon =
    highRiskCount > 0 ? (
      <AlertTriangle size={28} className="risk-summary-icon risk-summary-icon--alert" />
    ) : (
      <CheckCircle size={28} className="risk-summary-icon risk-summary-icon--ok" />
    );
    ...
    <div className="dashboard-root">
      <header className="dashboard-header">
        <div className="dashboard-title-row">
          <Shield size={32} className="dashboard-icon" />
